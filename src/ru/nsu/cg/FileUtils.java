...
public class FileUtils {
	 ...
	 */
	public static File getSaveFileName(JFrame parent, String extension, String description, File directory)
	{
	 ...
	 */
	public static File getOpenFileName(JFrame parent, String extension, String description, File directory)
	{
		JFileChooser fileChooser = new JFileChooser();
		FileFilter filter = new ExtensionFileFilter(extension, description);
		fileChooser.addChoosableFileFilter(filter);
